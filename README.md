...
Existing editorial fixture Chronicles are not regenerated by this change. Live OpenAI quality must be validated with credentials; automated tests use mocked provider responses.
